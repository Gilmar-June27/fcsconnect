...
$message_count = mysqli_fetch_assoc($select_messages)['count'];
  ...
  <div class="container mt-4">
    <h1 class="text-center text-success mt-4">Out of Deliver Orders</h1>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
            ...
            <tbody>
                <?php
                $select_orders = mysqli_query($conn, "SELECT * FROM `orders` WHERE admin_id='$admin_id' AND payment_status='out_of_delivered'") or die('query failed');
    ...
    <!-- <button type="submit" name="update_order" value="completed" class="btn btn-primary" <?php if($fetch_orders['payment_status'] == 'out_of_delivered') echo 'disabled'; ?>>Out Of Delivery</button> -->
</form>
