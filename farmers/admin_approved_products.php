...
<div class="container section-title" data-aos="fade-up">
      <p><span>Harvested</span> <span class="description-title">Product</span></p>
...
<section class="show-products py-5">
 ...
 <div class="row">
        <?php
    $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE admin_id = '$admin_id' AND havest_status = 'harvested'");
