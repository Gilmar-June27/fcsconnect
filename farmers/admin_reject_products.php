...
<!-- Section Title --><div class="container section-title" data-aos="fade-up">
      <p><span>Ready to pick up </span> <span class="description-title">Product</span></p>
...
<section class="show-products py-5">
 ...
 <div class="row">
        <?php
    $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE admin_id = '$admin_id' AND havest_status = 'ready_to_pick_up'");
