...
$message_count = mysqli_fetch_assoc($select_messages)['count'];
  ...
  <div class="container mt-4">
    <h1 class="text-center text-success mt-4">Completed Orders</h1>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered">
            ...
            <tbody>
                <?php
                $select_orders = mysqli_query($conn, "SELECT * FROM `orders` WHERE admin_id='$admin_id' AND payment_status='completed'") or die('query failed');
                ...
                <tr>
                    ...
                    <!-- <td>
                        <form action="" method="post">
                            ...
                            <select name="update_payment" class="form-control mb-2" <?php if($is_completed) echo 'disabled'; ?>>
                            ...
                            <button type="submit" name="update_order" class="btn btn-primary" <?php if($is_completed) echo 'disabled'; ?>>Update</button>
